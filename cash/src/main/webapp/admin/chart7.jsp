...
<html>
					...
					<td style="width:30%;">
						<div class="d-flex justify-content-end input-group mb-3">
							...
							<div class="input-group-append">
								<button type="button" id="outCategoryPolarAreaChartByYear" class="btn btn-outline-success">
									차트 보기
								</button>
							</div>
						</div>
	...
	<script>
		// 해당년도 총 카테고리 별 지출 차트
		$('#outCategoryPolarAreaChartByYear').click(function() {
			$('.hiden').text('단위 : 원');
			$.ajax({
